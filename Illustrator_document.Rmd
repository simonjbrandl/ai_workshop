...
![**Anchors and edges and handles oh my...**](Anchors&edges1.png) 
...
![**A beautiful grey star...**](Star1.png) 

![**...is just a whole lot of math (nerd-alert)...**](Star2.png)  
...
![**The various non-vector based graphics formats in a PowerPoint**](Presentation1.jpg)

![**A .pdf file gone horribly wrong (i.e., not adjusted to fit the artboard)**](Symbol1pdf.jpg) 
...
![**Opening a new document in AI... mind the size, dimensions, color mode and resolution**](NewDocumentComb.png)
...
![**Same colors, different colors (huh?). Top row shows RGB colors, bottom shows the exact same colors after switching to CMYK**](colorsRGBCMYK.png)
...
![**The dreaded exclamation mark of doom...**](ColorPanel.png)
...
![**D'oh... Don't check Brandl et al. 2018, Biol. Rev.!!!**](BrandlFig.png)
...
![**... (almost) everything you need in the box to the left**](BeyonceLeft.jpg)
...
![**The bread-and-butter toolbar on the left. I have arranged it in rows of two columns that I will go through sequentially. Yours might be a single vertical column.**](LeftToolbar.png)

### I. Grab & move

![**I like to move it, move it (using only the "Selection" and "Direct Selection" tools...)**](ToolI.png)
...
![**Awkwardly distorted stars created using the white arrow, and then copied, moved, and re-scaled using the black arrow**](starseries.png)

### II. Artisanal selections
![**Refined, artisanal selection at your fingertips. The "Magic Wand" and "Lasso" Tools**](ToolII.png)
...
![**Edited version of the random dotplot, with all black dots changed to red.**](RandomDotplot_edited.png)
...
![**Edited version of the random dotplot, with a spatially defined group of dots changed back to black using the lasso tool.**](RandomDotplot_edited2.png)


### III. Free anchors

![**Anchors anybody?**](anchors.jpg)


![**Drawsies!! The "Pen" and "Curvature" tools.**](Freeanchors.png)
...
![**Fill and stroke. More on that later.**](fillstroke1.png)
...
![**Happy texting and lining with the "Type" and "Line segment" tools.**](Textlines.png)
...
![**The Type tool is pretty versatile in the creation of text, but all modification is done elsewhere**](TypeTool2.png)
...
![**Plenty of options in the Line Segment Toolbox**](LinesBox.png)



### V. That's not the shape of my heart

![**Making all sorts of shapes (except hearts) with the Rectangle Tool and toolbox**](Squaretool.png)
...
![**Oh the possibilities...**](Shapes.png)
...
![**The color selector panel**](colorselecttool.png)
...
![**The Live Paint Bucket tool hides in  the Shape Builder toolbox...**](ShapeBuilder.png)
...
![**A simple application of the Live Paint Bucket tool**](ocean_livepaint.png)
...
![**A much more complex application of the Live Paint Group tool to draw colorful fishies...**](Pleopardus1.png)



![**...or an entire reefscpae full of colorful fishies... from Casey et al. 2017, Oecologia**](Fig. 2_SJB.png)


#### The Eyedropper

![**The eyedropper tool...**](Eyedropper.png)
...
![**The Graph Tool offers a wide range of different graph types with data inputs. Not exactlyy ggplot2, but for conceptual graphs it might just to the job**](GraphTool.png)
...
![**Examples of the many different types of graphs you can produce. Bargraphs, piecharts, and whatever the heck the third one here is**](graphtool_AI.png)

This will suffice as a glimpse into the tools on the left. So let's soldier on to the right side of the board.

## b. Right now...

![**The right toolbar**](righttoolbar.png)
...
![**Stroking possibilities and dashing options in the stroke panel**](strokesection.png)
...
![**The sheer endless possibilities of stroking...**](strokes.png)


### I. The Gradient panel
